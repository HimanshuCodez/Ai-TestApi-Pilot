  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        {children}
        {showCloseButton && (
          <DialogPrimitive.Close className="absolute top-4 right-4 rounded-lg p-1 text-muted-foreground opacity-70 transition-opacity hover:opacity-100 hover:bg-white/10 focus:outline-none">
            <X className="size-4" />
